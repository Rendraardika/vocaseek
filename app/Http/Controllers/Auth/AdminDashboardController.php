...
class AdminDashboardController extends Controller
{
    public function getOverview()
    {
        ...
        // 3. Recent Activity (Tabel Dashboard)
        ...
        // 4. Return Response dengan User Info (PENTING untuk Role Management di Frontend)
        return response()->json([
            ...
            'dashboard_data' => [
                ...
                'partners' => [
                    ...
                    'growth' => "+5% vs last month" // Contoh statis, bisa dibuat dinamis seperti talentGrowth
                ],
                'openings' => [
    ...
    // Helper untuk menyesuaikan label status dengan UI
